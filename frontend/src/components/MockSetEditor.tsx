          ...
          <Row className="g-3">
            <Col xs={12}>
              <Form.Group>
                ...
                />
                <Form.Text>
                  Applying this set enables the mocks in the left list and disables every other
                  mock.
                </Form.Text>
              </Form.Group>
            </Col>
    ...
    <div className="mock-set-pane">
      <div className="mock-set-pane-header">
        <div>
          ...
          <div className="row-meta">{shown === total ? `${total}` : `${shown} of ${total}`}</div>
        </div>
        <Button
          type="button"
          size="sm"
