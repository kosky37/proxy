...
internal sealed class TrayApplicationContext : ApplicationContext
{
    ...
    private void StartServices()
    {
        ...
        {
            SetStatus("Could not find the Proxy repo (API + frontend).");
            _icon.ShowBalloonTip(8000, "Proxy", "Could not find src/Proxy.Api and frontend. Run this from the repository.", ToolTipIcon.Error);
            return;
        }
        ...
        Run("Start", () =>
        {
            ...
            _icon.ShowBalloonTip(4000, "Proxy", "Admin UI is ready. Click to open it.", ToolTipIcon.Info);
        });
    }
    ...
    private void SetStatus(string text)
    {
        void Apply()
        {
            ...
            _icon.Text = text.Length <= 63 ? $"Proxy — {text}" : "Proxy";
        }
