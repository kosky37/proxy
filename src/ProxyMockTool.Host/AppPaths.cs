...
internal sealed class AppPaths
{
    ...
    public string ApiAssembly => Path.Combine(ApiDirectory, "bin", "Release", "net10.0", "ProxyMockTool.Api.dll");
    public string ApiExecutable => Path.Combine(ApiDirectory, "bin", "Release", "net10.0", "ProxyMockTool.Api.exe");
    ...
    public static AppPaths? Find()
    {
        foreach (var start in new[] { Environment.CurrentDirectory, AppContext.BaseDirectory })
        {
            ...
            {
                var api = Path.Combine(directory.FullName, "src", "ProxyMockTool.Api", "ProxyMockTool.Api.csproj");
